...
JNIEXPORT jint JNICALL Java_ch_ethz_asl_dancebots_danceboteditor_Encoder_init(
...
JNIEXPORT jint JNICALL Java_ch_ethz_asl_dancebots_danceboteditor_Encoder_encode(
...
JNIEXPORT jint JNICALL Java_ch_ethz_asl_dancebots_danceboteditor_Encoder_encodeBufferInterleaved(
...
JNIEXPORT jint JNICALL Java_ch_ethz_asl_dancebots_danceboteditor_Encoder_flush(
...
JNIEXPORT void JNICALL Java_ch_ethz_asl_dancebots_danceboteditor_Encoder_close(
        JNIEnv *env, jclass cls, jint instanceIndex) {
simple_lame_lib_close(glfList.at(instanceIndex));
}

JNIEXPORT void JNICALL Java_ch_ethz_asl_dancebots_danceboteditor_Encoder_log
