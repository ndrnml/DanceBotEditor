...
/*
    ...
    Modified 2015 by Andrin Jenal at ETH Zurich
*/
...
BeatTracker::initialise(size_t channels, size_t stepSize, size_t blockSize)
{
	...
	channels > getMaxChannelCount()) {
        ...
        __android_log_print(ANDROID_LOG_VERBOSE, "BeatTrack",
                "BeatTracker::initialise: Unsupported channel count: %i", channels );
    ...
    if (stepSize != getPreferredStepSize()) {
        ...
        __android_log_print(ANDROID_LOG_VERBOSE, "BeatTrack",
                "ERROR: BeatTracker::initialise: Unsupported step size for this sample rate: %i",
                stepSize );
    ...
    if (blockSize != getPreferredBlockSize()) {
        ...
        __android_log_print(ANDROID_LOG_VERBOSE, "BeatTrack",
                "WARNING: BeatTracker::initialise: Sub-optimal block size for this sample rate: %i",
                blockSize );
                     ...
                     Vamp::RealTime timestamp)
{
	...
	cerr << "ERROR: BeatTracker::process: "
     ...
     __android_log_print(ANDROID_LOG_VERBOSE, "BeatTrack",
             "ERROR: BeatTracker::process: BeatTracker has not been initialised" );
...
BeatTracker::getRemainingFeatures()
{
    ...
    __android_log_print(ANDROID_LOG_VERBOSE, "BeatTrack",
            "ERROR: BeatTracker::getRemainingFeatures: BeatTracker has not been initialised" );
